...
-- Step 2: Create index for auth_user_id lookups
-- Note: unique constraint already created by migration 20251029010000
CREATE INDEX IF NOT EXISTS idx_users_auth_user_id ON users(auth_user_id);
-- Unique constraint: Already exists from prior migration

-- Function: get_user_phlocks_grouped
...
comment on function public.get_user_phlocks_grouped is 'Aggregates share metrics by track for the authenticated sender.';

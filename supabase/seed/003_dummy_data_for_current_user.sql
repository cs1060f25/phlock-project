...
BEGIN
  ...
  INSERT INTO shares (sender_id, recipient_id, track_id, track_name, artist_name, album_art_url, message, status, created_at) VALUES
  (emma_id, marcus_id, '0RiRZpuVRbi7oqRdSMwhQY', 'Sunflower', 'Post Malone', 'https://i.scdn.co/image/ab67616d0000b273e2e352d89826aef6dbd5ff8f', 'Spider-verse 🕷️', 'sent', NOW() - INTERVAL '8 hours'),
